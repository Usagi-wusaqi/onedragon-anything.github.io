...
> 点击名字可跳转对应功能的详细说明，带⚙️的为一条龙列表内可配置项
...
1. 可以使用 [`游戏助手-预备编队识别`](#预备编队识别) 页面的工具进行自动识别填写
2. 需要注意编队名称尽量<font color="red">不要只有一个字或者只有数字</font>的差异，以防识别错误
...
- 用于设置 `驱动盘拆解` 时的拆解依据，每天自动拆解一次启动盘
  - 启动盘拆解等级分为 S 及以下、A 及以下和 B，默认为 A 级以下
  - 全部已弃置为可选项，默认不开启
