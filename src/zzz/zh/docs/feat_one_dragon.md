...
| [真·拿命验收](./feat_game_assistant.md#拿命验收) | 用于自动完成`真·拿命验收`副本 |
...
1. 自动托管
   ...
   - **解锁条件**：随便观等级达到 35 级
   - 开启自动托管后，冗余流程对应的配置或开关项，会智能地被隐藏

2. 饮茶仙
   - 是否启用饮茶仙流程
   - 定期采办是否刷新：开启后，若定期采办任务未完成，会尝试刷新任务
...
7. 德丰大押
   - 百宝通兑换
     - 是否启用
     - 兑换优先级：设置高保真母盘、资深调查员记录等的兑换顺序
   - 云纹徽兑换
     - 是否启用
     - 兑换优先级：设置邦布系统控件、丁尼的兑换顺序
     - 是否兑换不限购丁尼
