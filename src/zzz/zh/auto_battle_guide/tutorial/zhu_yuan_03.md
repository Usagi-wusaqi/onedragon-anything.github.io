...
开始前，学习 [场景下的触发器](../basic/basic_02_scenes.md)
...
状态的时间判断，可以在 [状态表达式](../basic/basic_03_states.md) 的 `2.状态识别时间` 学习。
...
开始前，你需要学习如何在状态表达式中判断子弹数，见 [状态表达式](../basic/basic_03_states.md) 的 `3.状态值判断` 。
